# Simplified Binary Convert V1 - Sequence of 8 - It has no name yet!
...
while True:
    ...
    # The seperation of the inputted sequence divided into segments of 8
    ...
    for segment in segments:
        ...
        elif segment == "0000": # Below are segments of 8 
            converted_segments.append("c")
        elif segment == "0001":
            converted_segments.append("d")
        elif segment == "0010":
        ...
        elif segment == "0000": # 8 binary sequence - The above will not be necessary
            converted_segments.append("c")
        elif segment == "0001":
            converted_segments.append("d")
        elif segment == "0010":
